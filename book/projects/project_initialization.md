...
{{ '[GitHub organization]({url})'.format(url=github_org_url) }}
1. Go to: {{ github_org_url }} and click the "Teams" tab near the top of the GitHub Organization page
